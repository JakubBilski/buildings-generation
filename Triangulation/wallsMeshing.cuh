...
generateWallsResult meshWalls(generateWallsArgs args)
{
	...
	cudaMalloc(&d_frontMaterialGrains, sizeof(float2)*args.noWalls);
	cudaMalloc(&d_backMaterialGrains, sizeof(float2)*args.noWalls);
	...
	cudaMemcpy(d_frontMaterialGrains, args.frontMaterialGrains, sizeof(float3)*args.noWalls, cudaMemcpyHostToDevice);
	cudaMemcpy(d_backMaterialGrains, args.backMaterialGrains, sizeof(float3)*args.noWalls, cudaMemcpyHostToDevice);
